<template>
  <div>
    ...
    <section class="page-header"
      ...
      <a href="https://xgz59421.github.io/" class="btn" target="_blank" v-if="!mini">博客源码</a>
    </section>
          ...
          <el-col :span="10">
            <el-menu @select="selectTopbar" :default-active="topbar.active" mode="horizontal" menu-trigger="click">
              ...
              <el-submenu index="#webSites" v-if="webSites.length>0">
                ...
                <el-menu-item :index="'#webSites-'+index" v-for="(item,index) in webSites" :key="'#webSites'+index">
